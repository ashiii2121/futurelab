...
const Footer = () => {
  ...
  return (
    <>
      {/* Desktop Footer */}
      <div className="container-fluid p-0 d-lg-block d-md-none d-sm-none d-none" id="footer">
        <footer className="text-center text-lg-start text-white">
            ...
            <div className="row my-4">
              ...
              <div className="col-lg-3 col-md-12 col-sm-12 col-12 mb-4 mb-md-0">
                ...
                <ul className="list-unstyled">
                  <li>
                    <p>
                      <i className="fas fa-map-marker-alt pe-2"></i>No:38, Ground
                      Floor , Sumangali Sevashram Road, Cholanayakanahalli, Hebbal
                  ...
                  <li>
                    <a className="text-light" href="mailto:info@futurelabs.live">
                  ...
                  <li className="pt-5">
                    <h4>Stay Updated!</h4>
                    <p>
                      Subscribe to our WhatsApp Community for expert health tips, exclusive offers, and real-time updates on your lab test bookings.
                    </p>
                    <form className="form-whatsapp" onSubmit={handleWhatsappSubscribe}>
                      <div>
                        <input
          ...
          >
            <p className="disclaimer">
              ...
              provider for diagnosis and treatment. Future Labs is not liable for
              any decisions made based on the test results provided.
            </p>
          </div>
        </footer>
      </div>
      ...
      {/* Mobile Footer */}
      <footer className="mobile-footer container-fluid d-lg-none d-md-block d-sm-block d-block">
